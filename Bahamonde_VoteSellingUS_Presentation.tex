...
\author[shortname]{H\'ector Bahamonde, PhD}
...
\begin{minipage}{0.47\textwidth}
    \begin{itemize}
          ...
          \item Paper is about clientelism.
    \end{itemize}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\centering\includegraphics[scale=0.2]{/Users/hectorbahamonde/research/Vote_Selling/Journal_Cover.pdf}
\end{minipage}
\end{frame}
...
\begin{minipage}{0.47\textwidth}
    \begin{itemize}
          ...
          \item {\bf Does this question matter?} {\color{white}It \emph{does}: the figure gives the wrong impression that US voters systematically ``oppose'' vote buying, ``thus'' rarely engaging in it.}
    \end{itemize}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\centering\includegraphics[scale=0.75]{/Users/hectorbahamonde/research/Vote_Selling/figure/lapop:bar:chart:plot-1.pdf}
...
\begin{minipage}{0.47\textwidth}
    \begin{itemize}
          \item Americans have rarely been offered the chance to sell their vote.
          \item However, the question stands: \emph{Would they?}
          \item {\bf Does this question matter?} It \emph{does}: the figure gives the wrong impression that US voters systematically ``oppose'' vote buying, ``thus'' rarely engaging in it.
    \end{itemize}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\centering\includegraphics[scale=0.75]{/Users/hectorbahamonde/research/Vote_Selling/figure/lapop:bar:chart:plot-1.pdf}
...
\miniframeson
\begin{frame}\frametitle{Clientelism Literature Suffers from Selection Bias}
    \begin{itemize}
...
\begin{minipage}{0.7\textwidth}
    \begin{itemize}
          ...
          \item Party tickets.
          \item Institutional Change: from the \emph{viva voce} to the \emph{Australian ballot}.
    \end{itemize}
\end{minipage}
\begin{minipage}{0.1\textwidth}
\centering\includegraphics[scale=0.09]{/Users/hectorbahamonde/research/Vote_Selling/george_washington.jpg}
\end{minipage}
\end{frame}


\miniframeson
\begin{frame}\frametitle{Vote Buying is Rare Now}
    \begin{itemize}
...
\end{minipage}
\begin{minipage}{0.5\textwidth}
\centering\includegraphics[scale=0.6]{/Users/hectorbahamonde/research/Vote_Selling/figure/us:map:plot-1.pdf}
\end{minipage}
\end{frame}
...
\begin{frame}[plain]
 %\vspace{-0.5cm}
  \centering\includegraphics[scale=0.22]{/Users/hectorbahamonde/research/Vote_Selling/LE_1.pdf}
\end{frame}
...
\begin{frame}[plain]
 %\vspace{-0.5cm}
  \centering\includegraphics[scale=0.22]{/Users/hectorbahamonde/research/Vote_Selling/LE_2.pdf}
\end{frame}
...
\begin{frame}[plain]
 %\vspace{-0.5cm}
  \centering\includegraphics[scale=0.22]{/Users/hectorbahamonde/research/Vote_Selling/LE_3.pdf}
\end{frame}

\miniframeson
\begin{frame}\frametitle{Experimental Design: Controlling for Ordering Effects}
 %\vspace{-0.5cm}
  \centering\includegraphics[scale=0.65]{/Users/hectorbahamonde/research/Vote_Selling/Experimental_Flow_Figure.pdf}
\end{frame}
...
\end{minipage}
\begin{minipage}{0.5\textwidth}
\centering\includegraphics[scale=0.6]{/Users/hectorbahamonde/research/Vote_Selling/figure/barplot:figure:control:treatment-1.pdf}
\end{minipage}
\end{frame}
...
\miniframeson
\begin{frame}\frametitle{Modeling Individual Probabilities of Vote Selling}
\centering\includegraphics[scale=0.3]{/Users/hectorbahamonde/research/Vote_Selling/figure/list:analysis:individual:predictions:plot-1.pdf}
\end{frame}

\miniframeson
\begin{frame}\frametitle{Who wants to sell and who's lying?}
\begin{minipage}{0.4\textwidth}
    \begin{itemize}
...
\end{minipage}
\begin{minipage}{0.5\textwidth}
\centering\includegraphics[scale=0.65]{/Users/hectorbahamonde/research/Vote_Selling/figure/list:analysis:social:desirability:plot-1.pdf}
\end{minipage}
\end{frame}
...
\centering\includegraphics[scale=0.3]{/Users/hectorbahamonde/research/Vote_Selling/pricing_experiment.jpeg}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\centering\includegraphics[scale=0.7]{/Users/hectorbahamonde/research/Vote_Selling/price_plot.pdf}
\end{minipage}
\end{frame}
...
\centering\includegraphics[scale=0.2]{/Users/hectorbahamonde/research/Vote_Selling/figure/predictions:independent:variables:plot-1.pdf}
\end{frame}
...
\miniframeson
\begin{frame}\frametitle{What this Talk Was About}
    \begin{enumerate}
      \item Descriptive paper: the \emph{why}'s and \emph{how}'s were left for future iterations.
...
{\bf Future research}:
        \begin{enumerate}
          ...
          \item \emph{Paper} junto a Crist\'obal Qui\~ninao usando misma base de datos, pero con un \emph{conjoint experiment}. Usamos \emph{machine learning} para subclasificar \emph{vote-sellers}.
          \item Futura expansi\'on de este experimento via un \emph{Fondecyt}, pero usando metodo comparado (incluir otros paises, por lo pronto, Chile).
          \item {\bf Otros?}
        \end{enumerate}
...
\centering\includegraphics[scale=0.3]{/Users/hectorbahamonde/research/Vote_Selling/Appendix_1.png}
\end{frame}
...
\centering\includegraphics[scale=0.3]{/Users/hectorbahamonde/research/Vote_Selling/Appendix_2.png}
\end{frame}


\miniframesoff
\begin{frame}\frametitle{Distractor Paragraph: Direct Question (II)}
\centering\includegraphics[scale=0.3]{/Users/hectorbahamonde/research/Vote_Selling/Appendix_3.png}
\end{frame}
