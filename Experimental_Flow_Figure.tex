...
\draw[decoration={brace,mirror,raise=10pt},decorate]
  (-28,-2) -- node[black,midway,xshift=-0.7cm] {({\bf r})} (-28,-19);
                    ...
                    \node[draw,align=center,fill=orange,text=black] (PE1) at (1,-3) {Pricing Experiment}; % 1

                    \node[draw,align=center,fill=green,text=black] (LE1) at (43,-6)   {List Experiment  % 1
                    $
                  \mbox{{\bf (r)}}
                  \left\{
                        \begin{array}{llc}
                    ...
                    \path [green, out=10,in=180, ->] (9.2,-3) edge (14,-6);
                    ...
                    % 2
                    \node[draw,align=center,fill=green,text=black] (LE2) at (-.05,-15) {List Experiment  % 1
                    $
                    \mbox{{\bf (r)}}
                    \left\{
                        \begin{array}{llc}
                    ...
                    \node[draw,align=center,fill=orange,text=black] (PE2) at (63.5,-12) {Pricing Experiment}; % 2
