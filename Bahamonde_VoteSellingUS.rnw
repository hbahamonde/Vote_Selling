...
<<list:analysis:social:desirability:plot, echo = FALSE, fig.pos='h', warning = FALSE, message = F, fig.cap=soc.des.plot.note, fig.align='center', fig.width=5.5, fig.height=3,dpi=100, cache = FALSE, include = TRUE>>=
