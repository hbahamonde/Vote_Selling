...
Participants were also asked to declare which price they considered ``too cheap'' for their votes. The intention was to capture the respondent's willingness to sell. The test measures the lowest bound at which participants would perceive the least possible economic benefit but sufficiently enough to make them sell. Since is the lowest threshold, the understanding is that any higher price will still be economically attractive. 
