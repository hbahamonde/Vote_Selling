...
% Hook 0
This note proposes that the clientelism literature should ``bring voters back in'' by unifying the (separated) vote-buying and vote-selling literatures. In fact, it seems that whether studies focus on vote-buying or vote-selling has depended, in part, on methodological rather than theoretical decisions.\footnote{I thank one of the anonymous reviewers for this comment.} On the one hand, historical and/or ethnographic works describe clientelist transactions from the point of view of voters, focusing on the conditions that make vote-selling most likely \parencite{Posada-Carbo:1996aa,Sabato2001,Auyero2000,Szwarcberg2013,Borges2019}. On the other hand, statistical, survey-based and/or experimental-based work mostly explore vote-buying. Just to name a few examples, using a field experiment in Benin, \textcite{Wantchekon2003} stresses the role of incumbency on vote-buying. \textcite[227]{Jensen2013a} focuses on the impact of ``poverty on vote buying,'' while \textcite[84]{Khemani2015} shows that ``vote buying in poor democracies is associated with lower [public] investments.'' Except for several important quantitative studies \parencite{Hicken2015,Hicken2018,Corstange2012a,Nichter2014a}, the emphasis of statistical studies remains on studying vote-buying. Importantly, other statistical-based studies have explored attitudes towards vote-buying \parencite{Bratton2008a,Weitz-shapiro}. They suggest that there is a strong stigma attached to vote-buying, and that might lead voters to not necessarily be willing to sell their vote. For instance, \textcite[208]{GonzalezOcantos2014} designed a list experiment to study attitudes towards vote-buying in Latin America. They conclude that most respondents find vote-buying ``unacceptable when provided with a hypothetical example.''

While the quantitative literature has advanced a number of important avenues of research, it has overlooked a number of other important questions. The wording of the LAPOP question illustrates part of the issue. By focusing on vote-buying, it gives the falsely optimistic impression that U.S. voters systematically ``oppose'' vote-buying and, ``thus,'' almost never engage in clientelism (as \autoref{fig:lapop:bar:chart:plot} strongly suggests). Furthermore, most quantitative-empirical studies have been conducted in developing countries. Finally, scholarly work has usually focused on realized behaviors only. By ignoring the attitudes of potential (hypothetical) vote-sellers it threats causal inferences with selection bias issues. 


This paper makes both methodological and substantive contributions by shedding light on these issues by leveraging a list experiment about hypothetical vote-selling in a consolidated democracy. We believe studying hypothetical behaviors---such as the willingness to sell---is a valuable exercise. \textcite[131]{Geddes1990} explains the selection issues of studying ``only cases that have achieved the outcome of interest.'' That is, if we are interested in understanding the micro-dynamics of clientelism---particularly as a supply and demand issue---we should incorporate the preferences of both sellers and buyers, potential and/or actual. Since the focus of this paper is on the willingness to sell, it is our belief that we can also learn about \emph{unrealized} clientelist transactions. Following the lead of \textcite{GonzalezOcantos2014}, this paper presents evidence of hypothetical vote-selling in the United States. 
...
%
The paper began by establishing the tension between supply and demand sides within a clientelistic relationship.\todo{pending} 
