...
\todo{pending}
% Hook 0
This note proposes that the clientelism literature should ``bring the voters back in'' by unifying the (separated) buying and selling literatures. 


It seems that whether studies focus on vote-buying or vote-selling has depended, in part, on methodological rather than theoretical decisions. 

In general, ethnographers and historians have focused on the supply-side, emphasizing vote-selling (\textcite{Posada-Carbo:1996aa,Sabato2001,Auyero2000,Szwarcberg2013,Borges2019}).\footnote{I thank one of the anonymous reviewers for this comment.} 

However, except for several important quantitative studies (\textcite{Hicken2015,Hicken2018,Corstange2012a,Nichter2014a}), the emphasis of statistical studies remains on studying vote-buying. Just to name a few examples, using a field experiment in Benin, \textcite{Wantchekon2003} stresses the role of incumbency on vote-buying. \textcite{Jensen2013a} focuses on the impact of ``poverty on vote buying,'' while \textcite{Weitz-shapiro} focuses on the role of political competition and poverty on vote-buying. Finally, \textcite[84]{Khemani2015} shows that ``vote buying in poor democracies is associated with lower [public] investments.'' 

% HERE



Furthermore, most empirical studies have been conducted in developing countries. 




For instance, \textcite{GonzalezOcantos2014} designed a list experiment to study preferences about hypothetical vote-buying in Latin America. Thus, previous quantitative empirical studies do not offer satisfactory answers to broader questions about vote-selling outside of the developing world. 



%Despite a solid vote-buying literature, we lack a proper body of vote-selling research. A unified framework that stresses the preferences and incentives of both sellers and buyers is missing. Thus, this paper's analytical contribution is tackling this problem as a story of demand and supply, by explicitly considering the preferences of those who have the votes (voters), and those who demand them (parties). 


The current demand-side bias in the literature gives an incomplete picture; overlooking the supply-side gives the falsely optimistic impression that U.S. voters systematically oppose vote-buying and, ``thus,'' almost never engage in clientelism (as \autoref{fig:lapop:bar:chart:plot} strongly suggests). 

% Moreover, demand-side studies of clientelism have traditionally focused, with a few exceptions \parencite{Zarazaga2015a,Szwarcberg2013,Oliveros2016,Stokes:2013cj,Corstange2012a,Hicken2015a,Hicken2018,Bratton2008a} on what parties do by asking \emph{voters} about what parties do, introducing additional bias. %This \emph{reverse demand-side bias} might cause other problems too. For instance, not only asking (directly) survey respondents about illegal behaviors constitutes an important source of social desirability bias,\footnote{Actually suggesting that the number of \emph{never}(s) should be larger. See \textcite{Gonzalez-Ocantos2012}. However, and unfortunately, their focus is on vote-\emph{buying}, overlooking vote-\emph{selling} too. They ask whether ``candidates or activists gave [voters] a gift or did a favor.''} double-biasing these results. Also, \emph{indirectly} learning  about what parties do by asking voters, poses a number problems to causal inference. At least, individual responses should be  confounded with personal frustrations and/or negative opinions about political parties and politics in general.
...
This paper makes a methodological contribution, shedding light on these issues by leveraging a list experiment in a consolidated democracy. The experiment captures an hypothetical situation. We believe studying hypothetical behaviors---such as the willingness to sell---is still a valuable exercise. \textcite[131]{Geddes1990} explains the selection issues of studying ``only cases that have achieved the outcome of interest.'' That is, if we are interested in understanding the micro-dynamics of clientelism---particularly as a supply and demand issue---we should incorporate the preferences of both sellers and buyers, potential and/or actual. Since the focus of this paper is on the willingness to sell, it is our belief that we can also learn about \emph{unrealized} clientelist transactions. Notably, \textcite{GonzalezOcantos2014} constitutes one of the few examples of the study of preferences towards hypothetical vote-buying. Following their lead, the paper presents evidence of hypothetical vote-selling in the United States.
