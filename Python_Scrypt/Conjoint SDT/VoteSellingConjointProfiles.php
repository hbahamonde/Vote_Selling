...
$featurearray = array("Right to vote" => array("Citizens CANNOT vote in the next two elections","Citizens CAN vote in the next two elections"),"Right to run" => array("Citizens CANNOT run for office for the next two elections","Citizens CAN run for office for the next two elections"),"Right to associate" => array("Citizens CANNOT associate with others and form groups
","Citizens CAN associate with others and form groups
"),"Free press" => array("Media CANNOT confront the Government","Media CAN confront the Government"),"President Autonomy" => array("President CANNOT rule without Congress","President CAN rule without Congress"));
